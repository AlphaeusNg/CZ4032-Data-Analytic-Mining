...
print("\nAverage CBA-RG's run time with pruning: %f ms" % ((cba_rg_total_runtime / 10)*1000))
print("Average CBA-CB M1's run time with pruning: %f ms" % ((cba_cb_total_runtime / 10)*1000))
print("Average Total CBA-CB M1 + RG's run time with pruning: %f ms" % (((cba_cb_total_runtime+cba_rg_total_runtime)/10)*1000))
print("Average CBA's error rate with pruning: %f%%" % (error_total_rate / 10 * 100))
print("Average No. of rules in classifier with pruning: %d" % int(total_classifier_rule_num / 10))
print("Average No. of CARs with pruning: %d" % int(total_car / 10))
