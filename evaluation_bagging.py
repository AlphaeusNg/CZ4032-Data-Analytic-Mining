...
print("Average CBA's error rate without pruning: %f%%" % ((error_total_rate / ((number_of_partitions-1)*number_of_partitions)) * 100))
print("Average No. of rules in classifier without pruning: %d" % int(total_classifier_rule_num / ((number_of_partitions-1)*number_of_partitions)))
